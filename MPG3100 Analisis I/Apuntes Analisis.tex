...
\begin{theorem}
  Sea $[a,b]$ un intervalo cerrado. Entonces 
  \begin{enumerate}[(a)]
    \item $f$ es Riemann integrable si y solo si es continua en casi todo punto.
    \item Si $f$ es Riemann integrable, entonces es Lebesgue interable y las integrales coinciden.
  \end{enumerate}
\end{theorem}
