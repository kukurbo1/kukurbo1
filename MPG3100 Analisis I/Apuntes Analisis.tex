...
\begin{proof}
  ...
  \begin{itemize}
    ...
    Basta demostrar esto, pues implicaría que $\exists k_0$ tal que $\lam(A_{k_0}) > b + \d$ con $\d$ pequeño, y por el caso anterior $\exists K \subseteq A_{k_0}$ tal que
    \[\frac\d2 + \lam(K) > \lam(A_{k_0}).\]
...
\begin{proposition}
  ...
  \[ \forall \e>0, \exists \delta>0 \br{\mu(A) < \delta \implies \abs{\int_A f \ \mathrm{d}\mu < \e}}. \]
\end{proposition}
